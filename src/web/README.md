...
Frontend React 19 + Tailwind CSS, consumindo `docs/design-system/tokens.json` como fonte única de verdade de design (ADR-011).

**Status:** não iniciado.

## Antes do primeiro componente

1. Gerar `tailwind.config.ts` a partir de `docs/design-system/tokens.json`.
