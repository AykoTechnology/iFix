...
- **Alternativa considerada e descartada — manter Gilroy e Lufga sob premissa de "uso interno, não comercial":** a pergunta reaparece naturalmente, então fica registrada com a resposta.
  - **"Interno" e "não comercial" não são sinônimos no vocabulário dessas licenças.** EULAs de fonte raramente separam comercial de não comercial como se imagina; separam assentos, *tipo* de uso (desktop, webfont, app) e volume — e o licenciado é a **pessoa jurídica**. Software operado por uma empresa para conduzir o próprio negócio é uso empresarial, ainda que ninguém venda a fonte nem o software. "Não comercial" costuma cobrir projeto pessoal ou acadêmico, não ferramenta corporativa.
  - **O que o uso interno de fato reduziria:** elimina a redistribuição a terceiros, que era a dimensão cara (dispensaria licença OEM); torna o volume conhecido e limitado a funcionários em vez de *pageviews* públicos; e resolve a questão de múltiplos domínios. Sairia de "custo indeterminado" para "webfont dimensionada ao número de pessoas" — redução real, mas não eliminação.
  ...
  - **Nota de coerência:** o Épico 8.3 deste produto entrega um módulo de SAM que conta licenças autorizadas versus instaladas e calcula *true-up*. Operá-lo sobre uma fonte não licenciada seria uma posição difícil de sustentar diante de um cliente.
